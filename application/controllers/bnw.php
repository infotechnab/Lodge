        ...
        if ($this->session->userdata('admin_logged_in')) {
            ...
            if (($this->form_validation->run() == FALSE)) {
                ...
                if ($this->upload->do_upload('myfile')) {
                    ...
                    $manipulator->save('./contents/uploads/images/' . $_FILES['myfile']['name']);
                    //cropper closed               
                } else {
                    $productImg = NULL;
                }
                if ($this->upload->do_upload('myfileTwo')) {
                    ...
                    $newImage = $manipulator->crop($x1, $y1, $x2, $y2);
                    // saving file to uploads folder
                    $manipulator->save('./contents/uploads/images/' . $_FILES['myfileTwo']['name']);
                } else {
                    $productImgTwo = NULL;
                }
                if ($this->upload->do_upload('myfileThree')) {
                    ...
                    $newImage = $manipulator->crop($x1, $y1, $x2, $y2);
                    // saving file to uploads folder
                    $manipulator->save('./contents/uploads/images/' . $_FILES['myfileThree']['name']);
                } else {
...
// ============================= End Add Product ====================================================//
    ...
    public function productImgdelete() {
        ...
        if ($this->session->userdata('admin_logged_in')) {
            ...
            // die($image);
            if (isset($image)) {
                unlink('./contents/uploads/images/' . $image);
            } else {
                $image = NULL;
            }
...
//            {
//                unlink('./contents/uploads/images/' . $imgOne);
//            }
//          //  else{}
//            if(isset($imgTwo)==!NULL)
//            {
//                unlink('./contents/uploads/images/' . $imgTwo);
//           }
//          //  else{}
//            if(isset($imgThree)==!NULL)
//           {
//                unlink('./contents/uploads/images/' . $imgThree);
//           }
//          //  else{}
//            
//            
