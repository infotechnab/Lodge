        ...
        <?php if ($meta)
{
    ...
    {        
       ...
       $i++;      
                     ...
                     ?>
        <link rel="shortcut icon" href="<?php echo base_url().'contents/uploads/images/'. $meta_data[4]; ?>" type="image/x-icon">
       
        <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        <script type="text/javascript" src="<?php echo base_url(); ?>contents/engine1/jquery.js"></script>
<!--        <link rel="icon" type="image/jpg" href="<?php echo base_url(); ?>content/images/bnw.jpg">-->
    ...
    <?php foreach ($headertitle as $header) {
                ...
                <div class="header">
                    <img src="<?php echo base_url().'contents/uploads/images/'.$header->description ; ?>" width="150" height="150" />
                </div>
                <?php } ?>
